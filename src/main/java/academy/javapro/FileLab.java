/* Project: File Data Processor Lab
 * Class: FileLab.java
 * Author: MEHMET SOYDAN
 * Date: 04/12/2025
 * This program processes sales data records, allowing users to filter and display
 * sales information based on quantity, price, and region criteria.
 */
